 ...
 *               $ref: '#/components/schemas/Error'
 */
router.delete('/:id', authenticateJWT, authorize(UserRole.ADMIN), asyncHandler(categoryController.deleteCategory));
 ...
 *               $ref: '#/components/schemas/Error'
 */
router.get('/statistics/overview', categoryController.getCategoryStatistics);
